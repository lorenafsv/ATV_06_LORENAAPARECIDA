...
document.getElementById('adicionarDecimal').addEventListener('click', () => {
    const input1 = parseFloat(document.getElementById('inputDecimal1').value);
    const input2 = parseFloat(document.getElementById('inputDecimal2').value);
    const resultado = calculadoraDecimal.Adicao(input1, input2);
    document.getElementById('resultadoDecimal').innerText = `Resultado: ${resultado}`;
});
...
document.getElementById('dividirDecimal').addEventListener('click', () => {
    ...
    try {
        ...
        document.getElementById('resultadoDecimal').innerText = `Erro: ${error.message}`;
    }
});
// Ações dos botões para a calculadora hexadecimal
document.getElementById('adicionarHex').addEventListener('click', () => {
    const input1 = parseInt(document.getElementById('inputHex1').value, 10);
    const input2 = parseInt(document.getElementById('inputHex2').value, 10);
    ...
    document.getElementById('resultadoHex').innerText = `Resultado: ${resultadoHex}`;
});
...
document.getElementById('dividirHex').addEventListener('click', () => {
    ...
    try {
        ...
        document.getElementById('resultadoHex').innerText = `Erro: ${error.message}`;
    }
});
